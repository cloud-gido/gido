...
GIDO_FLINK_OPERATOR_UI_URL_TEMPLATE="${GIDO_FLINK_OPERATOR_UI_URL_TEMPLATE:-}"
GIDO_FLINK_OPERATOR_BROWSER_JM_BASE="${GIDO_FLINK_OPERATOR_BROWSER_JM_BASE:-}"
...
sed \
  ...
  -e "s#__FLINK_OPERATOR_UI_URL_TEMPLATE__#${GIDO_FLINK_OPERATOR_UI_URL_TEMPLATE}#g" \
  -e "s#__FLINK_OPERATOR_BROWSER_JM_BASE__#${GIDO_FLINK_OPERATOR_BROWSER_JM_BASE}#g" \
  "${MANIFEST}" > "${RENDERED}"
