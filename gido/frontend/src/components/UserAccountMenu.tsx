...
import { formatSpaceContextLabel, formatUserContextLabel } from '../utils/roleLabels'
...
export default function UserAccountMenu() {
  ...
  const { platform: platformRole, space: spaceRole } = formatUserContextLabel(user, currentWorkspace)
  const spaceContext = formatSpaceContextLabel(currentWorkspace)
  ...
  const identityBlock: NonNullable<MenuProps['items']> = [
    {
      key: 'identity',
      type: 'group',
      label: '身份',
